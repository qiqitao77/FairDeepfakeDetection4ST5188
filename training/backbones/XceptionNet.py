...
class SeparableConv2d(nn.Module):
    def __init__(self, in_channels, out_channels, kernel_size=1, stride=1, padding=0, dilation=1, bias=False):
        ...
        self.conv1 = nn.Conv2d(in_channels, in_channels, kernel_size,
                               stride, padding, dilation, groups=in_channels, bias=bias) # depthwise convolution implemented by group convolution
...
class XceptionNet(nn.Module):
    ...
    def __init__(self, xception_config):
        ...
        self.mode = xception_config["mode"] # shallow_xception or None
        self.adjust_mode = xception_config["adjust_mode"] # newly added by Qiqi
        inc = xception_config["inc"] # input_channel
