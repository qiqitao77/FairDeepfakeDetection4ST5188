...
pretrained_settings = {
    'xception': {
        'imagenet': {
            ...
            'path': '/data/qiqitao/FairDeepfakeDetection/training/backbones/xception-b5690688.pth', # pre-trained weights on ImageNet downloaded from url above.
            'input_space': 'RGB',
...
if __name__ == '__main__':
    x = xception(1000, pretrained=False)
    f = x.features
    for name, param in x.named_parameters():
        print(f'paramter: {name}; param values: {param}.')
    print(x)
    print(1)